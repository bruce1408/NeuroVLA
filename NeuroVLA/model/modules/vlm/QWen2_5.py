...
_ACTION_TOKEN_MAX = 153712 # here only for fast_tokenizer, see NeuroVLA/model/modules/vlm/tools/add_qwen_special_tokens/README.md
...
class _QWen_VL_Interface(nn.Module):
    ...
    def build_qwenvl_inputs(self, images, instructions, solutions=None, **kwargs):
        ...
        if solutions is not None:
            ...
            action_token_max = _ACTION_TOKEN_MAX # here only for fast_tokenizer, see NeuroVLA/model/modules/vlm/tools/add_qwen_special_tokens/README.md
            ...
            for i in range(labels.size(0)):
                ...
                if nonzero_indices.numel() > 0:
                    ...
                    seq[:] = IGNORE_INDEX
                    RuntimeWarning (f"action token are on in yout tokenizer, plz see NeuroVLA/model/modules/vlm/tools/add_qwen_special_tokens/README.md.")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_yaml", type=str, default="./NeuroVLA/config/training/internvla_cotrain_custom.yaml", help="Path to YAML config")
